...
const SaasAdminLayout: React.FC = () => {
  ...
  // Navigation items
  const navItems = [
    { text: 'Dashboard', icon: <DashboardIcon />, path: '/saas-admin/dashboard' },
    { text: 'Tenants', icon: <BusinessIcon />, path: '/saas-admin/tenants' },
    { text: 'Users', icon: <PeopleIcon />, path: '/saas-admin/users' },
    { text: 'Settings', icon: <SettingsIcon />, path: '/saas-admin/settings' },
  ];
