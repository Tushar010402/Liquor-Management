...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'liquor_db'),
        'USER': os.getenv('DB_USER', 'liquor_user'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'liquor_password'),
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'reporting_service.common.exceptions.custom_exception_handler',
}
...
SALES_SERVICE_URL = os.getenv('SALES_SERVICE_URL', 'http://sales-service:8002')
ACCOUNTING_SERVICE_URL = os.getenv('ACCOUNTING_SERVICE_URL', 'http://accounting-service:8006')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs/reporting_service.log'),
            'formatter': 'verbose',
        },
    },
    'loggers': {
